      ...
      <div className="relative  h-screen flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 w-80  p-4 shadow-xl shadow-blue-gray-900/5">
        ...
        <nav className="flex flex-col gap-1 min-w-[240px] p-2 font-sans text-base font-normal text-gray-700">
          ...
          >
            ...
            <Link to="/layout/purchase">Purchase Orders</Link> 
          </div>
          ...
          >
            ...
            <Link to="/layout/supplier">Supplier</Link>
          </div>
          <div
            role="button"
            tabIndex="0"
          ...
          >
            ...
            <Link to="/layout/batch">Batch</Link>
          </div>
          <div
            role="button"
            tabIndex="0"
          ...
          >
            ...
            <Link to="/layout/baling">Bale</Link>
